						...
						<mm_table type="2">
							<thead>
								<tr>
									...
									<th scope="col" class="th_city"><mm_reverse title="城市" v-model="query.orderby" field="city_id" :func="search"></mm_reverse></th>
									<th scope="col" class="th_onoff"><mm_reverse title="显示" v-model="query.orderby" field="show" :func="search"></mm_reverse></th>
									<th scope="col" class="th_num"><mm_reverse title="顺序" v-model="query.orderby" field="display" :func="search"></mm_reverse></th>
